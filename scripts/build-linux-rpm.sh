...
# Octaskly .rpm Package Builder
# Creates a professional RPM package for RHEL/Fedora/CentOS
# Usage: bash build-linux-rpm.sh [ARCH]
# Example: bash build-linux-rpm.sh x86_64
